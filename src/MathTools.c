 ...
 */
/******************************************************************************/
static const U16 SQRT_TAB_HI_RES[] =
{
 ...
 */
/******************************************************************************/
static const U16 SQRT_TAB_LOW_RES[] =
{
...
static const U16 SqrtHiResTableSize  = sizeof(SQRT_TAB_HI_RES)/sizeof(U16);
static const U16 SqrtLowResTableSize = sizeof(SQRT_TAB_LOW_RES)/sizeof(U16);

#define SQRT_TABLES_SIZE_B                        (U16)(9u)
#define SQRT_TABLES_SIZE                          (U16)(1u << SQRT_TABLES_SIZE_B)

#define SQRT_TAB_HI_RES_BITS                      (U16)(13u)
#define SQRT_TAB_HI_RES_RANGE                     (U16)(1u << SQRT_TAB_HI_RES_BITS)
#define SQRT_TAB_HI_RES_DIV                       (U16)(SQRT_TAB_HI_RES_BITS - SQRT_TABLES_SIZE_B)


#define SQRT_TAB_LOW_RES_BITS                     (U16)(15u)
#define SQRT_TAB_LOW_RES_RANGE                    (U16)(1u << SQRT_TAB_LOW_RES_BITS)
#define SQRT_TAB_LOW_RES_DIV                      (U16)(SQRT_TAB_LOW_RES_BITS - SQRT_TABLES_SIZE_B)
...
S16 sqrt_16(U16 val)
{
  ...
  if(val < SQRT_TAB_HI_RES_RANGE)
  {
    // get sqrt from high resolution tab 0 ... 0.25 -> 0 ... 8192
    idx = (val >> SQRT_TAB_HI_RES_DIV) % SqrtHiResTableSize;
    sqrt = SQRT_TAB_HI_RES[idx];
  }
  else if(val < SQRT_TAB_LOW_RES_RANGE)
  {
    // low resolution table 0.25 <= val <= 1 -> 8192 <= val <= 32768
    idx = ((val >> SQRT_TAB_LOW_RES_DIV) - (SQRT_TAB_HI_RES_RANGE >> SQRT_TAB_LOW_RES_DIV)) % SqrtLowResTableSize;
    sqrt = SQRT_TAB_LOW_RES[idx];
  }
  else
  {
    sqrt = 32768u;
...
U16 fmul_qu15(U16 quA, U16 quB)
{
  U16 res;
	...
	CORCONbits.IF = 0;  // Put DSP Engine in fractional mode
	CORCONbits.US = 1;	// Put DSP In Unsigned Mode
