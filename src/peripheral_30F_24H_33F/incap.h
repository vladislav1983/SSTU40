...
#define IC_SYNC_TRIG_IN_IC1			0xffe5	/* Sync or Trigger input is IC1 */
#define IC_SYNC_TRIG_IN_IC2			0xffe6	/* Sync or Trigger input is IC2 */
#define IC_SYNC_TRIG_IN_IC3			0xffe7	/* Sync or Trigger input is IC3 */
#define IC_SYNC_TRIG_IN_IC4			0xffe8	/* Sync or Trigger input is IC4 */
...
#define IC_SYNC_TRIG_IN_IC1_INT		0xfff0	/* Sync or Trigger input is ICAP1 Interrupt */
#define IC_SYNC_TRIG_IN_IC2_INT		0xfff1	/* Sync or Trigger input is ICAP2 Interrupt */
#define IC_SYNC_TRIG_IN_IC3_INT		0xfff2	/* Sync or Trigger input is ICAP3 Interrupt */
#define IC_SYNC_TRIG_IN_IC4_INT		0xfff3	/* Sync or Trigger input is ICAP4 Interrupt */
#define IC_SYNC_TRIG_IN_CMP4		0xfff6	/* Sync or Trigger input is CMP4 */
#define IC_SYNC_TRIG_IN_CMP5		0xfff7	/* Sync or Trigger input is CMP5 */
...
#define IC_SYNC_TRIG_IN_CMP2		0xfff9	/* Sync or Trigger input is CMP2 */
#define IC_SYNC_TRIG_IN_CMP3		0xfffa	/* Sync or Trigger input is CMP3 */
#define IC_SYNC_TRIG_IN_CMP4		0xfffb	/* Sync or Trigger input is CMP4 */
