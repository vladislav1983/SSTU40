...
/* DCICON3 register Configuration bit definitions */

#ifdef _BCGSEL
#define DCI_CLK_SRC_FCY		0x7FFF /* DCI clock generator clock source is the system clock */
#define DCI_CLK_SRC_AUX		0xFFFF /* DCI clock generator clock source is the 48MHz USB clock */
#endif
