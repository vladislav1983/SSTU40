...
/*----------------------------------------------------------------------------------------------------*/
/* PWMCONx Configuration Bit Definitions :      */
/*----------------------------------------------------------------------------------------------------*/
...
/*----------------------------------------------------------------------------------------------------*/
/* IOCONx Configuration Bit Definitions :             */
/*----------------------------------------------------------------------------------------------------*/
...
/*----------------------------------------------------------------------------------------------------*/
/* FCLCONx Configuration Bit Definitions : */
/*----------------------------------------------------------------------------------------------------*/
...
#define PWM_CL_FLT1					0x0400  /* Current Limit control signal select source FLT1 for PWMx Gen bits */
#define PWM_CL_FLT2					0x0800  /* Current Limit control signal select source FLT2 for PWMx Gen bits */
#define PWM_CL_FLT3					0x0C00  /* Current Limit control signal select source FLT3 for PWMx Gen bits */
#define PWM_CL_FLT4					0x1000  /* Current Limit control signal select source FLT4 for PWMx Gen bits */
#define PWM_CL_FLT5					0x1400  /* Current Limit control signal select source FLT5 for PWMx Gen bits */
#define PWM_CL_FLT6					0x1800  /* Current Limit control signal select source FLT6 for PWMx Gen bits */
#define PWM_CL_FLT7					0x1C00  /* Current Limit control signal select source FLT7 for PWMx Gen bits */
#define PWM_CL_FLT8					0x2000 /* Current Limit control signal select source FLT8 for PWMx Gen bits */
#define PWM_CL_FLT9					0x2400 /* Current Limit control signal select source FLT9 for PWMx Gen bits */
#define PWM_CL_FLT10				0x2800 /* Current Limit control signal select source FLT10 for PWMx Gen bits */
#define PWM_CL_FLT11				0x2C00 /* Current Limit control signal select source FLT11 for PWMx Gen bits */
#define PWM_CL_FLT12				0x3000 /* Current Limit control signal select source FLT12 for PWMx Gen bits */
#define PWM_CL_CMP1 				0x3400  /* Current Limit control signal select source CMP1 for PWMx Gen bits */
#define PWM_CL_CMP2					0x3800  /* Current Limit control signal select source CMP2 for PWMx Gen bits */
#define PWM_CL_CMP3					0x3C00  /* Current Limit control signal select source CMP3 for PWMx Gen bits */
#define PWM_CL_CMP4					0x4000  /* Current Limit control signal select source CMP4 for PWMx Gen bits */
...
#define PWM_FLT_FLT1					0x0400  /* Fault control signal select source FLT1 for PWMx Gen bits */
#define PWM_FLT_FLT2					0x0800  /* Fault control signal select source FLT2 for PWMx Gen bits */
#define PWM_FLT_FLT3					0x0C00  /* Fault control signal select source FLT3 for PWMx Gen bits */
#define PWM_FLT_FLT4					0x1000  /* Fault control signal select source FLT4 for PWMx Gen bits */
#define PWM_FLT_FLT5					0x1400  /* Fault control signal select source FLT5 for PWMx Gen bits */
#define PWM_FLT_FLT6					0x1800  /* Fault control signal select source FLT6 for PWMx Gen bits */
#define PWM_FLT_FLT7					0x1C00  /* Fault control signal select source FLT7 for PWMx Gen bits */
#define PWM_FLT_FLT8					0x2000  /* Fault control signal select source FLT8 for PWMx Gen bits */
#define PWM_FLT_FLT9					0x2400  /* Fault control signal select source FLT9 for PWMx Gen bits */
#define PWM_FLT_FLT10					0x2800  /* Fault control signal select source FLT10 for PWMx Gen bits */
#define PWM_FLT_FLT11					0x2C00  /* Fault control signal select source FLT11 for PWMx Gen bits */
#define PWM_FLT_FLT12					0x3000  /* Fault control signal select source FLT12 for PWMx Gen bits */
#define PWM_FLT_CMP1 					0x3400  /* Fault control signal select source CMP1 for PWMx Gen bits */
#define PWM_FLT_CMP2					0x3800  /* Fault control signal select source CMP2 for PWMx Gen bits */
#define PWM_FLT_CMP3					0x3C00  /* Fault control signal select source CMP3 for PWMx Gen bits */
#define PWM_FLT_CMP4					0x4000  /* Fault control signal select source CMP4 for PWMx Gen bits */
...
/*----------------------------------------------------------------------------------------------------------------*/
/* TRGCONx Configuration Bit Definitions :                  */
/*----------------------------------------------------------------------------------------------------------------*/
...
/*----------------------------------------------------------------------------------------------------*/
/* LEBCONx Configuration Bit Definitions :      */
/*----------------------------------------------------------------------------------------------------*/
...
/*----------------------------------------------------------------------------------------------------*/
/* AUXCONx Configuration Bit Definitions :   */
/*----------------------------------------------------------------------------------------------------*/
...
#define HI_RES_PWM_DTC_DIS 0x4000    //High resolution PWM duty cycle  is disabled to reduce power consumption
...
#if defined (_CCSMD)
void SetHSPWMSecTrigCmp1(unsigned int TrigCmp_Val) __attribute__ ((section (".libperi")));
void SetHSPWMSecTrigCmp2(unsigned int TrigCmp_Val) __attribute__ ((section (".libperi")));
void SetHSPWMSecTrigCmp3(unsigned int TrigCmp_Val) __attribute__ ((section (".libperi")));
void SetHSPWMSecTrigCmp4(unsigned int TrigCmp_Val) __attribute__ ((section (".libperi")));
void SetHSPWMSecTrigCmp5(unsigned int TrigCmp_Val) __attribute__ ((section (".libperi")));
#endif
