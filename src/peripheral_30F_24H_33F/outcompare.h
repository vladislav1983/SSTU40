...
#define OC_SYNC_TRIG_IN_IC1_INT		0xfff0	/* Sync or Trigger input is ICAP1 Interrupt */
#define OC_SYNC_TRIG_IN_IC2_INT		0xfff1	/* Sync or Trigger input is ICAP2 Interrupt */
#define OC_SYNC_TRIG_IN_IC3_INT		0xfff2	/* Sync or Trigger input is ICAP3 Interrupt */
#define OC_SYNC_TRIG_IN_IC4_INT		0xfff3	/* Sync or Trigger input is ICAP4 Interrupt */
#define OC_SYNC_TRIG_IN_CMP4		0xfff6	/* Sync or Trigger input is CMP4 */
#define OC_SYNC_TRIG_IN_CMP5		0xfff7	/* Sync or Trigger input is CMP5 */
...
#define OC_SYNC_TRIG_IN_OCRS		0xffff	/* Sync or Trigger input is OCxRS */
...
#define OC_SYNC_TRIG_IN_OC3		0xffe3	/* Sync or Trigger input is OC3 */
#define OC_SYNC_TRIG_IN_OC4		0xffe4	/* Sync or Trigger input is OC4 */
#define OC_SYNC_TRIG_IN_IC1		0xffe5	/* Sync or Trigger input is IC1 */
#define OC_SYNC_TRIG_IN_IC2		0xffe6	/* Sync or Trigger input is IC2 */
#define OC_SYNC_TRIG_IN_IC3		0xffe7	/* Sync or Trigger input is IC3 */
#define OC_SYNC_TRIG_IN_IC4		0xffe8	/* Sync or Trigger input is IC4 */
#define OC_SYNC_TRIG_IN_TMR1		0xffeb	/* Sync or Trigger input is Timer1 */
#define OC_SYNC_TRIG_IN_TMR2		0xffec	/* Sync or Trigger input is Timer2 */
#define OC_SYNC_TRIG_IN_TMR3		0xffed	/* Sync or Trigger input is Timer3 */
#define OC_SYNC_TRIG_IN_TMR4		0xffee	/* Sync or Trigger input is Timer4 */
...
#define OC_SYNC_TRIG_IN_CMP2		0xfff9	/* Sync or Trigger input is CMP2 */
#define OC_SYNC_TRIG_IN_CMP3		0xfffa	/* Sync or Trigger input is CMP3 */
#define OC_SYNC_TRIG_IN_CMP4		0xfffb	/* Sync or Trigger input is CMP4 */
