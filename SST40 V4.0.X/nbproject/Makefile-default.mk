...
${OBJECTDIR}/_ext/1360937237/DigitalIO.o: ../src/DigitalIO.c  nbproject/Makefile-${CND_CONF}.mk
	...
	@${FIXDEPS} "${OBJECTDIR}/_ext/1360937237/DigitalIO.o.d" $(SILENT) -rsi ${MP_CC_DIR}../ -c ${MP_CC} $(MP_EXTRA_CC_PRE) -g -D__DEBUG  -omf=elf -x c -c -mcpu=$(MP_PROCESSOR_OPTION) -Wall -DROTARY_ENCODER_USED -I"../src/Common" -I"../src/include" -I"." -I"../src/RotaryEncoder" -mlarge-code -mlarge-data -mconst-in-code -O1 -MMD -MF "${OBJECTDIR}/_ext/1360937237/DigitalIO.o.d" -o ${OBJECTDIR}/_ext/1360937237/DigitalIO.o ../src/DigitalIO.c    
