...
${OBJECTDIR}/_ext/659864977/pid.o: ../src/pid/pid.c  nbproject/Makefile-${CND_CONF}.mk
	...
	@${FIXDEPS} "${OBJECTDIR}/_ext/659864977/pid.o.d" $(SILENT) -rsi ${MP_CC_DIR}../ -c ${MP_CC} $(MP_EXTRA_CC_PRE) -g -D__DEBUG -D__MPLAB_DEBUGGER_SIMULATOR=1 -omf=elf -x c -c -mcpu=$(MP_PROCESSOR_OPTION) -Wall -DROTARY_ENCODER_USED -I"." -I"../src/include" -I"../src/Common" -I"../src/RotaryEncoder" -I"../src/pid" -I"../src/peripheral_30F_24H_33F" -mlarge-code -mlarge-data -mconst-in-code -O1 -MMD -MF "${OBJECTDIR}/_ext/659864977/pid.o.d" -o ${OBJECTDIR}/_ext/659864977/pid.o ../src/pid/pid.c     -save-temps
...
${OBJECTDIR}/_ext/659864977/pid.o: ../src/pid/pid.c  nbproject/Makefile-${CND_CONF}.mk
	...
	@${RM} ${OBJECTDIR}/_ext/659864977/pid.o.ok ${OBJECTDIR}/_ext/659864977/pid.o.err 
	@${RM} ${OBJECTDIR}/_ext/659864977/pid.o 
	@${FIXDEPS} "${OBJECTDIR}/_ext/659864977/pid.o.d" $(SILENT) -rsi ${MP_CC_DIR}../ -c ${MP_CC} $(MP_EXTRA_CC_PRE)  -g -omf=elf -x c -c -mcpu=$(MP_PROCESSOR_OPTION) -Wall -DROTARY_ENCODER_USED -I"." -I"../src/include" -I"../src/Common" -I"../src/RotaryEncoder" -I"../src/pid" -I"../src/peripheral_30F_24H_33F" -mlarge-code -mlarge-data -mconst-in-code -O1 -MMD -MF "${OBJECTDIR}/_ext/659864977/pid.o.d" -o ${OBJECTDIR}/_ext/659864977/pid.o ../src/pid/pid.c     -save-temps
...
dist/${CND_CONF}/${IMAGE_TYPE}/SST40_V4.0.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}: ${OBJECTFILES}  nbproject/Makefile-${CND_CONF}.mk    
	...
	${MP_CC} $(MP_EXTRA_LD_PRE)  -omf=elf -mcpu=$(MP_PROCESSOR_OPTION)  -D__DEBUG -D__MPLAB_DEBUGGER_SIMULATOR=1 -o dist/${CND_CONF}/${IMAGE_TYPE}/SST40_V4.0.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX} ${OBJECTFILES_QUOTED_IF_SPACED}         -Wl,--defsym=__MPLAB_BUILD=1,-L"..",-L".",-Map="${DISTDIR}/SST40_V4.0.X.${IMAGE_TYPE}.map",--report-mem,--cref$(MP_EXTRA_LD_POST)$(MP_LINKER_FILE_OPTION),--defsym=__MPLAB_DEBUG=1,--defsym=__DEBUG=1,--defsym=__MPLAB_DEBUGGER_SIMULATOR=1
else
dist/${CND_CONF}/${IMAGE_TYPE}/SST40_V4.0.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}: ${OBJECTFILES}  nbproject/Makefile-${CND_CONF}.mk   
	@${MKDIR} dist/${CND_CONF}/${IMAGE_TYPE} 
	${MP_CC} $(MP_EXTRA_LD_PRE)  -omf=elf -mcpu=$(MP_PROCESSOR_OPTION)  -o dist/${CND_CONF}/${IMAGE_TYPE}/SST40_V4.0.X.${IMAGE_TYPE}.${DEBUGGABLE_SUFFIX} ${OBJECTFILES_QUOTED_IF_SPACED}         -Wl,--defsym=__MPLAB_BUILD=1,-L"..",-L".",-Map="${DISTDIR}/SST40_V4.0.X.${IMAGE_TYPE}.map",--report-mem,--cref$(MP_EXTRA_LD_POST)$(MP_LINKER_FILE_OPTION)
